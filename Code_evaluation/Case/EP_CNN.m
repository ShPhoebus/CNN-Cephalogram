ground_truth_file = 'dataset_ground_truth_labels_Case_no_Aug.csv';
predictions_file = 'dataset_prediction_labels_Case_no_Aug.csv';
AB_points_file = 'AB_Case.csv';
...
for i = 1:size(ground_truth_numeric, 1)
    for j = 1:(size(ground_truth_numeric, 2) / 2)
        dist_pixels = sqrt((predictions_numeric(i, j) - ground_truth_numeric(i, j))^2 + ...
                           (predictions_numeric(i, j + 25) - ground_truth_numeric(i, j + 25))^2);
