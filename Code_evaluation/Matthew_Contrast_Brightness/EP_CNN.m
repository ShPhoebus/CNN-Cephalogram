ground_truth_file = 'dataset_ground_truth_labels_contrast brightness.csv';
predictions_file = 'dataset_prediction_labels_contrast brightness.csv';
AB_points_file = 'AB_Matthew_Contrast.csv';
