ground_truth_file = 'dataset_ground_truth_labels_Hflip.csv';
predictions_file = 'dataset_prediction_labels_Hflip.csv';
AB_points_file = 'AB_Matthew_Horizonal_Flip.csv';
